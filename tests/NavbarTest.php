<?php
use Dyon\Flatstrapper\Navbar;
use Dyon\Flatstrapper\Navigation;

class NavbarTest extends FlatstrapperWrapper
{
    ...
    {
        //<a href="#" class="brand">Dyon\Flatstrapper</a>
        $navbar = Navbar::create()->with_brand('Dyon\Flatstrapper', '#');
        $matcher = $this->getBasicMatcher();
        $matcher['child']['child']['child'] = array(
            'tag' => 'a',
            'attributes' => array('class' => 'brand', 'href' => '#'),
            'content' => 'Dyon\Flatstrapper'
        );
